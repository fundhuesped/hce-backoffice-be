...
class PatientPrescriptionMedication(models.Model):
    ...
    patientMedication = models.ForeignKey(PatientMedication, null=True, blank=True)
    quantityPerDay = models.IntegerField(null=True)
    quantityPerMonth = models.IntegerField(null=True)
    prescription = models.ForeignKey(PatientPrescription, null=True, related_name='prescriptedMedications')
    class Meta:        
        """
